...
VL_MODULE(Vtest_top) {
  public:
    ...
    CData/*5:0*/ __Vchglast__TOP__test_top__core_top0__exe0__DOT__exe_type_m0__DOT__mul0__DOT__ready_temp;
  ...
  public:
    ...
    static void traceChgThis__10(Vtest_top__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
    static void traceChgThis__11(Vtest_top__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
    static void traceChgThis__12(Vtest_top__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
    static void traceChgThis__13(Vtest_top__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
    ...
    static void traceChgThis__9(Vtest_top__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
